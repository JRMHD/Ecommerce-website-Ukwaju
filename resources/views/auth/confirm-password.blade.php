...
<head>
    ...
    <title>Confirm Password | Ukwaju</title>
...
<body class="bg-white min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md animate-fade-in">
        ...
        <div class="bg-white rounded-2xl custom-shadow p-8">
            <h2 class="text-2xl font-bold text-center mb-6 text-gray-800">Security Check</h2>
        ...
        <p class="text-center mt-8 text-gray-600">
            <a href="{{ url()->previous() }}" class="text-purple-600 hover:text-purple-800 font-semibold">
                ← Cancel
            </a>
        </p>
    </div>
